    ...
    <div className="relative overflow-hidden flex-1">
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        ...
        <MotionDiv
          initial={{ opacity: 0, y: 8 }}
          animate={{ opacity: 0.8, y: 0 }}
          transition={{ duration: 1 }} className="absolute -bottom-28 left-0 right-0 h-72">
          <MotionDiv
            className="absolute left-0 top-0 flex h-full w-[200%]"
            animate={{ x: ["-50%", "0%"] }}
        ...
        <section className="grid items-center gap-10 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <h1 className="text-balance text-4xl font-semibold tracking-tight sm:text-5xl">
              ...
              <br />
              I build polished web solutions.
            </h1>
            <p className="max-w-prose text-pretty text-base leading-7 text-zinc-600 dark:text-zinc-300">
            I take pride in excelling in a 
versatile environment, and love working with a team to 
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-600 dark:text-zinc-300">
                Clean architecture, fast pages, and details that make interfaces
                feel premium.
              </p>
            </div>
            <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-600 dark:text-zinc-300">
                Next.js, Tailwind, Motion, and a few small utilities to keep the
                UI crisp.
              </p>
            </div>
            <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 sm:col-span-2">
              ...
              <p className="mt-4 text-sm leading-6 text-zinc-600 dark:text-zinc-300">
                Want to see more? Head to the portfolio page for a few sample
                case studies.
              </p>
            </div>
          </div>
